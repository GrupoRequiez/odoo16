...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        if not self.user_id:
            raise UserError(_("Vendor has not been assigned!!!!"))
        elif not self.type_id:
            raise UserError(_("Type has not been assigned!!!!"))
        elif not self.client_order_ref:
            raise UserError(_("Client order ref has not been assigned!!!!"))
        elif not self.date_promised:
            raise UserError(_("Date planned has not been assigned!!!!"))
        else:
