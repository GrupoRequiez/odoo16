        ...
        for record in self:
            ...
            if quant_qty > 0:
                ...
                if remaining_qty >= 0:
                    ...
                    return {
                'warning': {'title': _('Warning'), 'message': _("The available stock is not enough for this record %s %s" % (record.internal_location_id.name, record.product_id.default_code))
                           }
            }
            else:
                return {
